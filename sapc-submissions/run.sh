...
if [ $stage -le 1 ] && [ $stop_stage -ge 1 ]; then
    ...
    # pip install torch==2.0.0+cu118 torchaudio==2.0.0+cu118 -f https://download.pytorch.org/whl/cu118/torch_stable.html
    conda install cudnn --yes
    pip install whisperx
    pip install torch==2.1.0+cu118 torchaudio==2.1.0+cu118 -f https://download.pytorch.org/whl/cu118/torch_stable.html
    pip install "numpy<2"
    pip install openai
    pip install tqdm
    ##########################################################################
